...
class UserSchema(Base):
    ...
    last_marked = Column(Integer, default=0)
...
class StatementSchema(Base):
    ...
    article_fk = Column(Integer, ForeignKey("articles.page_id"), index=True, nullable=False)
    user_fk = Column(String(200), ForeignKey("users.user_id"),index=True, nullable=False)
